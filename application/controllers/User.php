		...
		public function index()
			{
				...
				$this->load->view('user/home-new', $data);
			}
		...
		public function event()
			{
				...
				//form
				$this->load->view('user/event-new', $data);
			}
		...
		public function download()
			{
				...
				//form
				$this->load->view('user/download-new', $data);
			}
		...
		public function reply()
			{
						...
						$this->load->view('user/reply-new', $data);
			}
		...
		public function change_password()
			{
						...
						//form
						$this->load->view('user/change_password-new');
			}
		...
		public function offline_town_portal()
			{
				...
				//form
				$this->load->view('user/offline_town_portal-new', $data);
			}
		...
		public function acquire_super_shue()
			{
				...
				//form
				$this->load->view('user/acquire_super_shue-new', $data);
			}
		...
		public function buy_all_skill()
			{
				...
				//form
				$this->load->view('user/buy_all_skill-new', $data);
			}
		...
		public function equip_super_super_shue()
			{
				...
				//form
				$this->load->view('user/equip_super_super_shue-new', $data);
			}
		...
		public function buy_lore()
			{
				...
				//form
				$this->load->view('user/buy_lore-new', $data);
			}
		...
		public function rebirth()
			{
				...
				//form
				$this->load->view('user/rebirth-new', $data);
			}
		...
		public function reset_rebirth()
			{
				...
				//form
				$this->load->view('user/reset_rebirth-new', $data);
			}
		...
		public function mercenary_rebirth()
			{
				...
				//form
				$this->load->view('user/mercenary_rebirth-new', $data);
			}
		...
		public function mercenary_reset_rebirth()
			{
				...
				//form
				$this->load->view('user/mercenary_reset_rebirth-new', $data);
			}
		...
		public function adding_hero_stat_points()
			{
				//process
				$data['query'] = $this->charac0->charac_char();
				$this->load->view('user/adding_hero_stat_points-new', $data);
			}
		...
		public function char_points()
			{
				...
				//form
				$this->load->view('user/char_points-new', $data);
			}
		...
		public function adding_mercenary_stat_points()
			{
				...
				$data['query'] = $this->charac0->charac_char();
				//process
				$this->load->view('user/adding_mercenary_stat_points-new', $data);
			}
		...
		public function merc_points()
			{
				...
				//form
				$this->load->view('user/merc_points-new', $data);
			}
