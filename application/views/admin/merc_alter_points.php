	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="title col-12 col-lg-8">
				<h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">Modifying Mercenary Points</h2>

				<h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">How to use this AMT?</h3>

				<ol class="list-group">
					<li class="list-group-item">key in the mercenary name as you desire</li>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="media-container-column col-lg-8" data-form-type="formoid">
				...
				<p class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">Searching Mercenary</p>

				<div class="form-group row">
					<?=form_label('Mercenary : ', 'lp', array('class' => 'col-sm-2 col-form-label mbr-fonts-style display-7')) ?>
					<div class="col-sm-10">
						<?=form_input(array('name' => 'merc', 'value' => set_value('merc'), 'class' => 'form-control', 'id' => 'lp', 'placeholder' => 'Mercenary'))?>
						<br />
						<?=form_error('merc')?>
					</div>
				</div>
...
<?php if(!$this->input->post('search', TRUE) || $this->form_validation->run() == FALSE || !isset($query->row()->HSID) ):?>
<?php else:?>
				<p class="mbr-text pb-3 mbr-fonts-style display-5">The Master of <b><font color="#FF0000"><?=$query->row()->HSName?></font></b> is <b><font color="#FF0000"><?=$query->row()->MasterName?></font></b></p>

				<?=form_open('', array('class' => 'mbr-form', 'autocomplete' => 'off', 'id' => 'productForm'), array('merc' => $query->row()->HSID ))?>
...
<table class="table table-sm table-striped table-bordered">
	<tr>
		...
		<td><span id="str3"><?=merc_attrib('STR', $query->row()->Ability)?></span></td>
		<td>+</font></td>
		<td>
	...
	<tr>
		...
		<td><span id="int3"><?=merc_attrib('INT', $query->row()->Ability)?></span></td>
		<td>+</td>
		<td>
	...
	<tr>
		...
		<td><span id="dex3"><?=merc_attrib('DEX', $query->row()->Ability)?></span></td>
		<td>+</td>
		<td>
	...
	<tr>
		...
		<td><span id="vit3"><?=merc_attrib('VIT', $query->row()->Ability)?></span></td>
		<td>+</td>
		<td>
	...
	<tr>
		...
		<td><span id="mana3"><?=merc_attrib('MANA', $query->row()->Ability)?></span></td>
		<td>+</td>
		<td>
	...
	<tr>
		...
		<td><span id="prem3"><?=merc_attrib('POINTS', $query->row()->Ability)?></span></td>
		<td>+</td>
		<td>
		...
		<td><span id="prem2"><?=@$prem?></span></td>
				...
				<div class="row">
					<div class="col-sm-12">
						<span class="input-group-btn">
							<?=form_submit('alter', 'Alter '.$query->row()->HSName, 'class="btn btn-primary btn-form display-4"')?>
						</span>
					</div>
				</div>
