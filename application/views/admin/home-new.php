	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="title col-12 col-lg-8">
				<h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">Updating News and Announcement</h2>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="media-container-column col-lg-8" data-form-type="formoid">
				...
				<div class="form-group row">
					<div class="col-sm-12">
						<?=form_textarea('news_add', NULL, 'id="textarea"')?>
						<br />
						<?=form_error('news_add')?>
					</div>
				</div>
							...
							<table class="table table-hover" id="table1">
								...
								<?foreach($news->result() as $t):?>
									<tr>
										...
										<td><?=$t->Subject?></td>
										<td><?=$t->HTML?></td>
										<td><?=anchor('admin/news_edit/'.$t->Bil, '<i class="fa fa-pencil" aria-hidden="true"></i>Edit', 'title = "EDIT NEWS '.$t->Bil.'"')?></td>
										<td><?=anchor('admin/news_del/'.$t->Bil, '<i class="fa fa-trash" aria-hidden="true"></i>Delete', 'title = "DELETE NEWS '.$t->Bil.'"')?></td>
									</tr>
									<?endforeach?>
								</table>
							</div>
