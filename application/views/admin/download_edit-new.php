	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="media-container-column col-lg-8" data-form-type="formoid">
				...
				<div class="form-group row">
					<div class="col-sm-12">
						<?=form_textarea('download_edit', $news->row()->HTML, 'id="textarea"')?>
						<br />
						<?=form_error('download_edit')?>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<span class="input-group-btn">
								<button type="submit" class="btn btn-primary btn-form display-4">EDIT DOWNLOAD</button>
							</span>
						</div>
					</div>
...
////////////////////////////////////////////////////////////////////////////////////
// ckeditor
CKEDITOR.replace( 'download_edit' );
