	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="title col-12 col-lg-8">
				...
				<h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">This is the same as player can reset rebirth their own char. All conditions for reset rebirth is still the same which means their woonz and rebirth level 15 (or 16...i cant remember... -.-&quot;) need to be met before this features can be used</h3>
			</div>
		</div>
	</div>
	<div class="container">
