		...
		<div class="container">
			<div class="inner-container" style="width: 66%;">
				...
				<div class="section-text align-center mbr-white mbr-fonts-style display-5">
					<h2 class="mbr-section-title align-center pb-3 mbr-white mbr-fonts-style display-2">Player Online</h2>
					<p class="mbr-text pb-3 mbr-white mbr-fonts-style display-5"><font color="#FF0000"><blink><?=@$info?></blink></font></p>

<?php if ($query2->num_rows() < 1): ?>
	<p class="mbr-text pb-3 mbr-white mbr-fonts-style display-5">There are no player at the moment</p>
<? else:?>
